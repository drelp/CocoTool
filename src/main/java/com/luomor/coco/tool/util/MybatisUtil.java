...
public class MybatisUtil {
    ...
    private static File dbFile = new File(SystemUtil.CONFIG_HOME + File.separator + "CocoTool.db");
        ...
        if (sqlSession == null) {
            try {
                ...
                if (StringUtils.isNotBlank(App.config.getDbFilePath())) {
                    dbFile = new File(App.config.getDbFilePath() + File.separator + "CocoTool.db");
                }
