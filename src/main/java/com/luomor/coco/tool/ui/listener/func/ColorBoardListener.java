...
import com.luomor.coco.tool.ui.dialog.CommonTipsDialog;
import com.luomor.coco.tool.ui.dialog.FavoriteColorDialog;
import com.luomor.coco.tool.ui.form.func.ColorBoardForm;
    ...
    public static void addListeners() {
        ...
        colorBoardForm.getAboutLabel().addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                tipsBuilder.append("<p><b>注：CocoTool的取色器实时预览的色值存在微小误差，请以鼠标点击取色后的色值为准</b></p>");
