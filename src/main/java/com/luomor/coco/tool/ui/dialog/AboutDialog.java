package com.luomor.coco.tool.ui.dialog;
    ...
    public AboutDialog() {
        ...
        logoLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    desktop.browse(new URI("https://drelp.github.io/CocoTool/"));
        ...
        authorLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Desktop desktop = Desktop.getDesktop();
                try {
                    desktop.browse(new URI("http://www.luomor.com/"));
                } catch (IOException | URISyntaxException e1) {
                    e1.printStackTrace();
                }
            }
        ...
        codeGitHubLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Desktop desktop = Desktop.getDesktop();
                try {
                    desktop.browse(new URI("https://github.com/drelp/CocoTool"));
                } catch (IOException | URISyntaxException e1) {
                    e1.printStackTrace();
                }
            }
        ...
        codeGiteeLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Desktop desktop = Desktop.getDesktop();
                try {
                    desktop.browse(new URI("https://gitee.com/yiluxiangbei/CocoTool"));
                } catch (IOException | URISyntaxException e1) {
                    e1.printStackTrace();
                }
            }
        ...
        issueLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Desktop desktop = Desktop.getDesktop();
                try {
                    desktop.browse(new URI("https://github.com/drelp/CocoTool/issues"));
                } catch (IOException | URISyntaxException e1) {
                    e1.printStackTrace();
                }
            }
        ...
        wePushPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Desktop desktop = Desktop.getDesktop();
                try {
                    desktop.browse(new URI("https://github.com/drelp/pumpkin-tensorflow"));
                } catch (IOException | URISyntaxException e1) {
                    e1.printStackTrace();
                }
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "CocoTool", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, this.$$$getFont$$$(null, Font.BOLD, 20, panel2.getFont()), new Color(-7883)));
        final JLabel label1 = new JLabel();
        label1.setText("A handy desktop toolset for developers");
        panel2.add(label1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        authorLabel = new JLabel();
        authorLabel.setText("Proudly by Peter  Zhang");
        ...
        label2.setText("Hi. Thanks to use CocoTool. \"Coco\" named from my daughter.");
        ...
        codeGitHubLabel.setText("<html>GitHub：<a href=\"https://github.com/drelp/CocoTool\">https://github.com/drelp/CocoTool</a></html>");
        ...
        codeGiteeLabel.setText("<html>Gitee：<a href=\"https://gitee.com/yiluxiangbei/CocoTool\">https://gitee.com/yiluxiangbei/CocoTool</a></html>");
        ...
        issueLabel.setText("<html><a href=\"https://github.com/drelp/CocoTool/issues\">https://github.com/drelp/CocoTool/issues</a></html>");
        ...
        label7.setIcon(new ImageIcon(getClass().getResource("/icon/wx-peterzhang.jpeg")));
        label7.setText("");
        ...
        wePushLinkLabel.setText("<html><a href=\"https://github.com/drelp/pumpkin-tensorflow\">https://github.com/drelp/pumpkin-tensorflow</a></html>");
        ...
        label8.setIcon(new ImageIcon(getClass().getResource("/icon/tf_logo_transp.png")));
        label8.setText("");
        ...
        label9.setText("pumpkin-tensorflow");
        ...
        label10.setText("pumpkin-tensorflow");
