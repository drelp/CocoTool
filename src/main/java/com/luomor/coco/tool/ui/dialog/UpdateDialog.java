...
public class UpdateDialog extends JDialog {
    ...
    public UpdateDialog() {
        ...
        buttonDownloadFromWeb.addActionListener(e -> {
            ...
            try {
                desktop.browse(new URI("https://github.com/drelp/CocoTool/releases"));
    ...
    public void downLoad(String newVersion) {
        ...
        ThreadUtil.execute(
                () -> {
                    String fileUrl = "http://download.luomor.com/coco/exe/CocoTool-" + newVersion + "-x64-Setup.exe";
                    ...
                    File tempDir = new File(FileUtil.getTmpDirPath() + "CocoTool");
                    if (!tempDir.exists()) {
                        tempDir.mkdirs();
                    }
