package com.luomor.coco.tool.ui.form.func;
...
import com.luomor.coco.tool.dao.THostMapper;
import com.luomor.coco.tool.domain.THost;
import com.luomor.coco.tool.ui.Init;
import com.luomor.coco.tool.ui.UiConsts;
import com.luomor.coco.tool.ui.frame.ColorPickerFrame;
import com.luomor.coco.tool.ui.listener.func.HostListener;
import com.luomor.coco.tool.ui.listener.func.JsonBeautyListener;
import com.luomor.coco.tool.util.JTableUtil;
import com.luomor.coco.tool.util.MybatisUtil;
import com.luomor.coco.tool.util.SystemUtil;
import com.luomor.coco.tool.util.UIUtil;
import com.luomor.coco.tool.util.UndoUtil;
...
public class HostForm {
        ...
        try {
            ...
            if (SystemUtil.isWindowsOs()) {
                ...
                if (App.trayIcon != null) {
                    App.trayIcon.displayMessage("CocoTool", "Host已切换！\n" + hostName, TrayIcon.MessageType.INFO);
    ...
    public static void initListTable() {
        ...
        if (!SystemUtil.isLinuxOs()) {
            ...
            MenuItem openItem = new MenuItem("CocoTool");
