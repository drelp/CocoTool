...
import com.luomor.coco.tool.dao.TQrCodeMapper;
...
public class QrCodeForm {
    ...
    public static void init() {
        ...
        if (SystemUtil.isLinuxOs()) {
            ...
            tempDir = new File(FileUtil.getTmpDirPath() + "CocoTool");
        }
        if (!tempDir.exists()) {
            tempDir.mkdirs();
        }
    ...
    private static void initUi() {
        ...
        if (tQrCode != null && StringUtils.isNotEmpty(tQrCode.getContent())) {
            ...
            qrCodeForm.getToGenerateContentTextArea().setText("https://github.com/drelp/CocoTool");
        }
