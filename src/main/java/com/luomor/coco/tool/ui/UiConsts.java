package com.luomor.coco.tool.ui;
...
public class UiConsts {
     ...
     * 软件名称,版本
     */
    public static final String APP_NAME = "CocoTool";
     ...
     * 软件版本检查url
     */
    public static final String CHECK_VERSION_URL = "https://gitee.com/yiluxiangbei/CocoTool/raw/master/src/main/resources/version_summary.json";

    /**
     * 二维码url
     */
    public static final String QR_CODE_URL = "http://download.luomor.com/file/cocotool_qrcode.json";

    /**
     * 介绍二维码URL
     */
    public static final String INTRODUCE_QRCODE_URL = "http://download.luomor.com/qrcode/introduce-cocotool-qrcode.png";
